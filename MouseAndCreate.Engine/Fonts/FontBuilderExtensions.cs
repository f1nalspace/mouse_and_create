...
namespace MouseAndCreate.Fonts
{
    ...
    {
        public static void Add(this IFontBuilder builder, IFontBuilderContext context, string fontName, Stream fontStream, int fontIndex, float fontSize, IEnumerable<CodePointRange> ranges)
        {
            if (builder is null)
